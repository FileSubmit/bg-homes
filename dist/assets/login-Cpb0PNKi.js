function e(){return`<section class="mx-auto max-w-2xl px-4 py-16 sm:px-6 lg:px-8">
  <div class="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200 sm:p-10">
    ...
    <p class="mt-3 text-slate-600">Sign in to manage your saved listings and profile.</p>
    <form class="mt-8 space-y-5">
      ...
      <button class="rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white" type="submit">Sign in</button>
    </form>
  </div>
